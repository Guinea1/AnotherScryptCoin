...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/anotherscryptcoin/src
        cp anotherscryptcoind /usr/local/bin/
        cp anotherscryptcoin-cli /usr/local/bin/
...
-------
    ...
    ./src/anotherscryptcoind -daemon # Starts the anotherscryptcoin daemon.
    ./src/anotherscryptcoin-cli --help # Outputs a list of command-line options.
    ./src/anotherscryptcoin-cli help # Outputs a list of RPC commands when the daemon is running.
