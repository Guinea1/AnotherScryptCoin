# Support for Output Descriptors in AnotherScryptCoin Core

Since AnotherScryptCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `asc1...` for mainnet or `tasc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on AnotherScryptCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing AnotherScryptCoin Core wallets, a convenience function `combo` is
