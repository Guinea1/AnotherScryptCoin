...
bech32_templates = [
  ...
  ('asc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('asc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('asc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tasc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tasc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tasc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rasc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rasc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rasc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tasc',  17, 32, False, False, False),
  ('rasc',  3,  1, False, False, False),
  ('asc',   15, 41, False, False, False),
  ('tasc',  0, 16, False, False, False),
  ('rasc',  0, 32, True,  False, False),
  ('asc',   0, 16, True,  False, False),
  ('tasc',  0, 32, False, True,  False),
  ('rasc',  0, 20, False, False, True)
]
