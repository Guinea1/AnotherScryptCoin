...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " anotherscryptcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  anotherscryptcoin-tx [options] <hex-tx> [commands]  Update hex-encoded anotherscryptcoin transaction\n" +
            "or:     anotherscryptcoin-tx [options] -create [commands]   Create hex-encoded anotherscryptcoin transaction\n" +
            "\n";
