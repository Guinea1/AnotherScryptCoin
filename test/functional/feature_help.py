...
"""Verify that starting anotherscryptcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start anotherscryptcoin with -h for help text")
        ...
        self.log.info("Start anotherscryptcoin with -version for version information")
        ...
        self.log.info("Start anotherscryptcoind with -fakearg to make sure it does not start")
